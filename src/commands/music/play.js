...
module.exports = {
    ...
    async execute(interaction, client) {
        ...
        if (!interaction.member.voice.channel) {
            ...
            interaction.reply({ embeds: [no.setDescription(`Im already Playing music in a different channel`)], ephemeral: true })
        } else {
            ...
            try {
                ...
                if (res.loadType === 'LOAD_FAILED') {
                    ...
                    return interaction.reply({
                        embeds: [
                            yes
                            .setDescription(`Song ${track.title} has been added to queue`)
